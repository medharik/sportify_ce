...
<?php } ?>
                        <div class="row bg-light">
                            ...
                            <div class="col-md-6 mx-auto border">
                                <div class="form-group"><label for="user_id">user_id</label>
                                    <input type="text" class="form-control" name="user_id" id="user_id"
                                      value="<?=(isset($paiement)? $paiement->user_id:'')?>">
                                </div>
                                <div class="form-group"><label for="abonne_id">abonne_id</label>
                                    <input type="text" class="form-control" name="abonne_id" id="abonne_id" value="<?=(isset($paiement)? $paiement->abonne_id:'')?>">
                                </div>
                                ...
                                <div class="form-group"><label for="tarif_mois">Tarif par mois</label>
                                    <input type="number"  step="0.01" class="form-control" name="tarif_mois" id="tarif_mois"
                                     value="<?=(isset($paiement)? $paiement->tarif_mois:'')?>">
                                </div>
                                <div class="form-group"><label for="remise">Remise</label>
                                    <input type="number"  step="0.01" class="form-control" name="remise" id="remise"
                                     value="<?=(isset($paiement)? $paiement->remise:'')?>">
                                </div>


                                <div class="form-group"><label for="type_paiement">Mode de paiement</label>
                                    <input type="text"   class="form-control" name="type_paiement" id="type_paiement"
                                     value="<?=(isset($paiement)? $paiement->type_paiement:'')?>">
                                </div>
